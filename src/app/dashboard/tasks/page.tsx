...
import { Plus, MoreHorizontal, Edit, Trash2, Search, CheckCircle2 } from "lucide-react";
                ...
                {loading ? (
                  ...
                  filteredTasks.map((task, index) => (
                    ...
                    >
                      ...
                      <TableCell className="px-6 py-5 text-slate-600 dark:text-slate-300">{task.dueDate ? new Date(task.dueDate).toLocaleDateString() : 'N/A'}</TableCell>
                      {userRole !== "employee" && (
