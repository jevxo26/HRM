                  ...
                  <TableRow>
                    <TableCell colSpan={3} className="text-center h-48">
                      <div className="flex flex-col items-center justify-center gap-3">
                        ...
                        <span className="text-sm font-medium text-slate-500 dark:text-slate-400 animate-pulse">Loading amazing teams...</span>
                      </div>
                    </TableCell>
                  </TableRow>
                  ...
                  <TableRow>
                    <TableCell colSpan={3} className="text-center h-48">
                      <div className="flex flex-col items-center justify-center gap-2">
                        <UsersRound className="h-10 w-10 text-slate-300 dark:text-slate-700 mb-2" />
                        <span className="text-base font-medium text-slate-600 dark:text-slate-400">No teams found</span>
                    ...
                    >
                      <TableCell className="px-8 py-5">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <span className="font-semibold text-slate-900 dark:text-slate-100 text-base">{team.name}</span>
                          </div>
                        </div>
                      </TableCell>
